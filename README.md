...
Toujours entourer les variables de guillemets : "$VARIABLE".

Utiliser -r avec read pour éviter les problèmes d'échappement.

Tester les champs vides avec -z.

Utiliser $(()) pour les calculs arithmétiques.

Privilégier les doubles crochets [[ ... ]] pour les tests conditionnels.
